                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filter_name"
                                   placeholder="Nosaukums" <?= (isset($_GET['filter']['name']) && $_GET['filter']['name']) ? "value='{$_GET['filter']['name']}' name='filter[name]'" : NULL; ?> v-model="form.name">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-2 col-md-1">
                        <div class="form-group"
                            ...
                            <input type="tel" class="form-control" id="filter_amount"
                                   placeholder="Summa" <?= (isset($_GET['filter']['amount']) && $_GET['filter']['amount']) ? "value='{$_GET['filter']['amount']}' name='filter[amount]'" : NULL; ?> v-model.number="form.amount">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filter_performer"
                                   placeholder="Izpildītājs" <?= (isset($_GET['filter']['performer']) && $_GET['filter']['performer']) ? "value='{$_GET['filter']['performer']}' name='filter[performer]'" : NULL; ?> v-model="form.performer">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <select multiple size="10" class="form-control" name="filter[sections_id][]" id="filter_sections"
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <select multiple size="10" class="form-control" name="filter[elements_id][]" id="filter_elements"
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <select multiple size="10" class="form-control" name="filter[systems_id][]" id="filter_systems"
