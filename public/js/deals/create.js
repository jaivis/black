...
new Vue({
    ...
    methods: {
        openModal: function openModal(subtype, type) {
    ...
    watch: {
        'options.elements': function optionsElements(newVal, oldVal) {
            //  values
        ...
        'form.object': function formObject(newVal, oldVal) {
            //
            var inst = this;
            ...
            if (_id !== '' && !isNaN(_id)) {
                ...
                window.axios.get('/api/sections/parent/' + _id).then(function (response) {
        ...
        'form.element': function formElement(newVal, oldVal) {
            //
            window.loader('show');
            //
            var inst = this;
            ...
            if (_id !== '' && !isNaN(_id)) {
                ...
                window.axios.get('/api/types/parent/' + _id).then(function (response) {
        ...
        'form.type': function formType(newVal, oldVal) {
            ...
            if (_id !== '' && !isNaN(_id)) {
                ...
                window.axios.get('/api/systems/parent/' + _id).then(function (response) {
        ...
        'form.amount': function formAmount(newVal, oldVal) {
    ...
    mounted: function mounted() {
        ...
        window.axios.get('/api/elements').then(function (response) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(38).setImmediate))
